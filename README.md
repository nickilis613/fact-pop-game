...
- **Local progress:** XP, fact records, and preferences persist in this browser. Grown-ups can export a CSV report or explicitly confirm a reset. There are no accounts, analytics, or cloud synchronization.
